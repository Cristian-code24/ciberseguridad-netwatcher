...
def handle_export(args):
    ...
    sample_data = [
        {'IP': '192.168.1.1', 'MAC': 'AA:BB:CC:DD:EE:FF', 'Hostname': 'router.local', 'Vendor': 'Netgear', 'Puertos Abiertos': '53, 80'},
        {'IP': '192.168.1.100', 'MAC': '11:22:33:44:55:66', 'Hostname': 'mi-pc', 'Vendor': 'Intel', 'Puertos Abiertos': '22'}
    ]
    try:
...
def main():
    ...
    parser_arp.add_argument("--cidr", required=True, help="El rango de red en formato CIDR (ej. 192.168.1.0/24).")
    ...
    parser_nmap.add_argument("--ports", default="1-1024", help="Rango de puertos a escanear (ej. '22,80,443' o '1-1024').")
    ...
    parser_export.add_argument("--file", required=True, help="Nombre del archivo de salida (ej. 'resultados.csv').")
